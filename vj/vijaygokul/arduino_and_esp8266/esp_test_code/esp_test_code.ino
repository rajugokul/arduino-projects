...
String ssid ="DLK TECHNOLOGIES";
String password="!@12345DLK";



String data;

String server = "www.1croreads.com"; // www.example.com

String uri = "http://1croreads.com/test-soli-monotor-demo/get.php?";// our example is /esppost.php
...
data = "&s1=" + temp + "&s2=" + hum;// data sent must be under this form //name1=value1&name2=value2.
