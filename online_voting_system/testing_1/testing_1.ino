...
if(S =="5500B44D64C8" && lis5==0)
  ...
  else if(S =="5500B4469433" && lis1==1||S =="5500785D5020" && lis2==1||S =="5500B3C5587B" && lis3==1||S =="0000A6A9949B" && lis4==1||S =="5500B44D64C8" && lis5==1){
    tag=0;
    S="";
    lcd.clear();
    lcd.setCursor(0,0);
